...
function DevzWeb() {
  ...
  const faqs = [
    {
      question: "O DEVZ Web funciona totalmente online?",
      answer: "Sim, o DEVZ Web é uma solução 100% cloud que funciona através do navegador. Você pode acessar de qualquer lugar com internet, sem necessidade de instalação de software."
    },
    {
    ...
    },
    {
      ...
      answer: "Sim, o DEVZ Web possui integração nativa com os principais sistemas contábeis do mercado e exporta arquivos no formato exigido pelo seu contador."
    },
    {
    ...
    },
    {
      ...
      answer: "Como é uma solução cloud, o DEVZ Web requer conexão com internet. Porém, o aplicativo mobile possui algumas funcionalidades offline básicas."
    },
    {
    ...
    },
    {
      ...
      answer: "Totalmente. O DEVZ Web foi desenvolvido seguindo todas as diretrizes da LGPD, com controles de acesso, auditoria e políticas de privacidade integradas."
    }
  ];

  return (
    <ProductBase
      productName="DEVZ Web"
