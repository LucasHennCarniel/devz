  ...
  const faqs = [
    {
      ...
      answer: "Sim, o Avante® Clínicas segue todas as diretrizes do CFM para prontuários eletrônicos, incluindo assinatura digital, rastreabilidade e segurança dos dados."
    },
    {
