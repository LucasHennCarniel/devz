...
(function() {
    ...
    <div id="channel-chat-widget">
        <button id="channel-chat-button">
            <img src="https://chat.devzconecta.com.br/webchat-logo.png" alt="WebChat Logo">
        </button>
    </div>
    ...
    async function registerWebchat() {
        ...
        const tenantId = '1';
        const wabaId = '3ad3b83c-a438-49a5-a5c3-bc2d39a6a684';
        const websocketToken = '31df15b1-40a2-40f3-9e97-fbc0c71a4efc';
        const response = await fetch(`https://api.devzconecta.com.br/webchat/register/${wabaId}`, {
            method: 'POST',
            headers: { 
    ...
    function buildMediaUrl(mediaUrl) {
        ...
        const baseUrl = `https://api.devzconecta.com.br/public/${tenantId}`;
    ...
    async function loadMessageHistory() {
        try {
            const wabaId = '3ad3b83c-a438-49a5-a5c3-bc2d39a6a684';
            const websocketToken = '31df15b1-40a2-40f3-9e97-fbc0c71a4efc';
            const response = await fetch(`https://api.devzconecta.com.br/webchat/messages/${wabaId}?from=${webchatId}&tenantId=1`, {
                headers: {
                    'x-websocket-token': websocketToken
                }
            });
    ...
    async function sendMedia(file) {
        ...
        try {
            ...
            const response = await fetch(`https://api.devzconecta.com.br/webchat-webhook/${wabaId}`, {
                method: 'POST',
                headers: {
                    'x-websocket-token': websocketToken
                },
    ...
    messageInput.addEventListener('keypress', (e) => {
        console.log('[DEBUG] Tecla pressionada:', e.key, 'Valor atual:', messageInput.value);
        if (e.key === 'Enter') {
            sendButton.click();
        }
    });
    ...
    messageInput.addEventListener('input', (e) => {
        console.log('[DEBUG] Input alterado:', e.target.value);
    });
    ...
    function connectWebSocket() {
        ...
        function connect() {
            const wabaId = '3ad3b83c-a438-49a5-a5c3-bc2d39a6a684';
            const websocketToken = '31df15b1-40a2-40f3-9e97-fbc0c71a4efc';
            ws = new WebSocket(`wss://webchat.devzconecta.com.br/wss?from=${webchatId}&token=${token}`);
